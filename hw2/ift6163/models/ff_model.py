...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        delta_unnormalized = unnormalize(ptu.to_numpy(delta_pred_normalized), delta_mean, delta_std)
        next_obs_pred = obs_unnormalized + delta_unnormalized
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        """
        # Q1 get numpy array of the predicted next-states (s_t+1)
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        next_obs_pred, delta_pred_normalized = self(observations,
                                                    actions,
                                                    data_statistics['obs_mean'],
                                                    data_statistics['obs_std'],
                                                    data_statistics['acs_mean'],
